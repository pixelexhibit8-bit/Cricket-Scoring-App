...
export const buildFinishedMatch = (match, rosterByTeam = {}) => {
  ...
  return {
    ...
    sourceMatch: match,
    tournamentId: match.tournamentId || match.sourceMatch?.tournamentId || null,
    tournamentMatchId: match.tournamentMatchId || match.sourceMatch?.tournamentMatchId || null,
    tournamentName: match.tournamentName || match.sourceMatch?.tournamentName || null,
    team1,
    team2,
...
export function generateRoundRobinFixtures(teams = [], options = {}) {
  ...
  const validTeams = teams.map((t, idx) => ({
    ...
    shortName: t.shortName || t.shortCode || t.code || (typeof t === 'string' ? t.slice(0, 4).toUpperCase() : (t.name ? t.name.slice(0, 4).toUpperCase() : `T${idx + 1}`)),
    logoUri: t.logoUri || t.logoUrl || null,
    logoUrl: t.logoUrl || t.logoUri || null,
      ...
      if (!teamA.isDummy && !teamB.isDummy) {
        ...
        leagueFixtures.push({
          ...
          team1: {
            ...
            logoUri: teamA.logoUri,
            logoUrl: teamA.logoUrl,
            logoKey: teamA.logoKey,
            color: teamA.color,
            cardBg: teamA.cardBg,
          ...
          team2: {
            ...
            logoUri: teamB.logoUri,
            logoUrl: teamB.logoUrl,
            logoKey: teamB.logoKey,
            color: teamB.color,
            cardBg: teamB.cardBg,
