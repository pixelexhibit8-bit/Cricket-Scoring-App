...
const styles = StyleSheet.create({
  ...
  subFilterBtn: { flex: 1, flexDirection: 'column', alignItems: 'center', gap: 3, paddingVertical: 9, backgroundColor: theme.colors.surface, borderRadius: 10, borderWidth: 1, borderColor: theme.colors.borderDark },
  subFilterActive: { backgroundColor: theme.colors.primary, borderColor: theme.colors.primary },
  subFilterText: { fontSize: 10, color: theme.colors.textSecondary, fontFamily: systemFontBold },
